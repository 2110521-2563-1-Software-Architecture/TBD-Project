  ...
  const onSubmit = () => {
    if (
      ...
      if (validateEmail(account_id)) {
        ...
        UserService.register(sendToBackend)
          .then((res) => {
      ...
      <div style={page}>
        <Form name='register' onFinish={onSubmit}>
          <Row className='head'>
            ...
            <Col style={title}>It's quick and easy.</Col>
          </Row>
          <Row
            style={{
          ...
          >
            <Col span={12}>
              ...
              >
                <Input onChange={onChangeFirstname} placeholder='First name' />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
              ...
              >
                <Input onChange={onChangeSurname} placeholder='Surname' />
              </Form.Item>
            </Col>
          </Row>
